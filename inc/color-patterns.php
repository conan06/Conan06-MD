<?php
/**
 * Conan06 Material Design: Color Patterns
 *
 * @package WordPress
 * @subpackage ConanMD
 * @since 1.0
 ...
 */
function conanMD_custom_colors_css() {
	$hue = absint( get_theme_mod( 'colorscheme_hue', 250 ) );

	/**
	 * Filter Conan06 Material Design default saturation level.
	 *
	 * @since Conan06 Material Design 1.0
	 *
	 * @param $saturation integer
	 */
	$saturation = absint( apply_filters( 'conanMD_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.ConanMD-front-page) .entry-title,
...
.colors-custom .ConanMD-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.ConanMD-front-page .panel-content .recent-posts article,
...
.colors-custom.ConanMD-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	...
	/**
	 * Filters Conan06 Material Design custom colors CSS.
	 *
	 * @since Conan06 Material Design 1.0
	 *
	 ...
	 */
	return apply_filters( 'conanMD_custom_colors_css', $css, $hue, $saturation );
}
