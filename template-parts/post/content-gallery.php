...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<?php if ( is_home() ) : ?>
		<div class="mdl-card mdl-shadow--2dp">
			...
			<?php 
				if ( get_post_gallery() ) :
					echo '<div class="mdl-card__media entry-gallery">';
						echo get_post_gallery();
					echo '</div>';
				elseif ( '' !== get_the_post_thumbnail() && ! get_post_gallery() ) :
					echo '<figure class="mdl-card__media">';
					echo '<a href="' . get_the_permalink() . '">';
					echo the_post_thumbnail( 'ConanMD-featured-image' );
					echo '</a>';
					echo '</figure>';
				endif;
			?>
