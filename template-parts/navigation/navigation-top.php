...
<div class="mdl-layout mdl-js-layout mdl-layout--fixed-header mdl-layout--no-drawer-button">
	<header class="mdl-layout__header mdl-layout__header--transparent navigation-top">
		...
		<div class="mdl-layout__drawer-button" role="button" tabindex="0">
			<span><i class="navigation-icons"></i></span>
		</div>
		<div class="nav-search-form-back" role="button" tabindex="0"></div>
